...
function preload()
{
  ...
  star_0=loadAnimation("empty.png");
  stars_1=loadAnimation("one_star.png");
  stars_2=loadAnimation("stars.png");
...
function setup() 
{
  ...
  star.addAnimation('Zero_star',star_0);
  star.addAnimation('One_stars',stars_1);
  star.addAnimation('Two_stars',stars_2);
  star.changeAnimation('Zero_stars');
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)==true) {
    star1.visible=false;
    star.changeAnimation('One_stars');
  }

  if(collide(fruit,star2,20)==true) {
    star2.visible=false;
    star.changeAnimation('Two_stars');
  }
